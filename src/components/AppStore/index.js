...
class AppStore extends Component {
  ...
  render() {
    ...
    const genreAppList = this.filterAppsBasedOnGenre()
        ...
        <div className="app-store-container">
          ...
          <div className="search-bar-container">
            <input
              ...
              placeholder="Search"
              value={searchInput}
              onChange={this.onChangeSearchApp}
            />
            <img
          ...
          <ul className="tabs-list-items-container">
            {tabsList.map(eachTab => (
              <TabItem
                key={eachTab.tabId}
                eachTab={eachTab}
                changeGenreApps={this.changeGenreApps}
